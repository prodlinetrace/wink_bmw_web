...
from .. import db
from ..models import Product, Status, Operation, Operation_Type, Operation_Status, Station, Unit, Comment, User, Queue
...
def index():
    ...
    queues = Queue.query.order_by(Queue.id.asc())
    ...
    return render_template('statistics/index.html', products=products, statuses=statuses, operations=operations, operation_types=operation_types, operation_statuses=operation_statuses, stations=stations, units=units, comments=comments, users=users, queues=queues)
